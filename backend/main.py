import sys
import os
# Inject parent directory to sys.path so 'import backend' works when running from the backend directory
...
from backend.agents.bias_detector import detect_score_bias
...
# Initialize DB at import time to ensure tables are always created
init_db()
...
import bcrypt
from . import celery_mock as celery
from . import redis_mock as redis
from . import spacy_mock as spacy
from . import chromadb_mock as chromadb
import numpy as np
import scipy.optimize
from backend.models import DuplicateFlag, Assignment, BiasAlert, Result
